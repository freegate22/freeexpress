...
<button type="button" id="hd_ct"><i class="fa fa-bars" aria-hidden="true"></i><span class="sound_only">분류</span></button>
<div id="category">
    <div class="ct_wr">
        <div class="ct_login">
            <?php if ($is_member) { ?>
            ...
            <a href="<?php echo G5_BBS_URL ?>/register.php" id="snb_join">회원가입</a>
        ...
        ?>
        <button type="button" class="pop_close"><span class="sound_only">카테고리 닫기</span></button>
    </div>
</div>
