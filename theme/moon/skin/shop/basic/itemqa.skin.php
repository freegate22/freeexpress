    ...
    ?>
        ...
        <li class="sit_qa_li">
            ...
            <div class="sit_qa_cmd">
                <a href="<?php echo $itemqa_form."&amp;iq_id={$row['iq_id']}&amp;w=u"; ?>" class="itemqa_form " onclick="return false;"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">수정</span></a>
                <a href="<?php echo $itemqa_formupdate."&amp;iq_id={$row['iq_id']}&amp;w=d&amp;hash={$hash}"; ?>" class="itemqa_delete "><i class="fa fa-trash-o" aria-hidden="true"></i><span class="sound_only">삭제</span></a>
