    ...
    ?>
        ...
        <li class="sit_use_li">
            ...
            <div class="sit_use_cmd">
                <a href="<?php echo $itemuse_form."&amp;is_id={$row['is_id']}&amp;w=u"; ?>" class="itemuse_form " onclick="return false;"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">수정</span></a>
                <a href="<?php echo $itemuse_formupdate."&amp;is_id={$row['is_id']}&amp;w=d&amp;hash={$hash}"; ?>" class="itemuse_delete "><i class="fa fa-trash-o" aria-hidden="true"></i><span class="sound_only">삭제</span></a>
            </div>
            <?php } ?>
